...
public class Start extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        percentage.setForeground(new java.awt.Color(61, 142, 242));
        percentage.setText("%");

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Century Schoolbook", 3, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(61, 142, 242));
        jLabel4.setText("Loading...");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8-deadlines-68.png"))); // NOI18N
