...
public class TeamLeader extends javax.swing.JFrame {
    ...
    public TeamLeader() {
        initComponents();
        setInformation();
        show.DataInTable("team_leader", TLTable, 1);
    }
    ...
    private void initComponents() {
        ...
        TLTable.setFont(new java.awt.Font("Century Schoolbook", 3, 20)); // NOI18N
        TLTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "TL_id", "Name", "Password", "position", "pm_id"
            }
        ));
        TLTable.setRowHeight(25);
        TLTable.setSelectionBackground(new java.awt.Color(61, 142, 242));
        ...
        jLabel2.setText("\"Manage Team Leaders\" ");
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        if(checkData() && TLTable.getSelectedRowCount() == 1) {
            setData();
            type.update("team_leader", 6, TLTable);
            show.DataInTable("team_leader", TLTable, 1);
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        if(TLTable.getSelectedRowCount() == 1) {
            type.delete("team_leader", TLTable);
            show.DataInTable("team_leader", TLTable, 1);
    ...
    private void TLTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TLTableMouseClicked
        currentRow = TLTable.getSelectedRow();

        if (TLTable.getSelectedRowCount() == 1) {
            id.setText(TLTable.getValueAt(currentRow, 0) + "");
            name.setText(TLTable.getValueAt(currentRow, 1) + "");
            password.setText(TLTable.getValueAt(currentRow, 2) + "");
            pm_id.setText(TLTable.getValueAt(currentRow, 4) + "");
        }
