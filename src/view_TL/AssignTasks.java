...
public class AssignTasks extends javax.swing.JFrame {
    ...
    public AssignTasks() {
        initComponents();
        setInformation();
        show.DataInTable("tasks", taskTable, 5);
    }
    ...
    private void initComponents() {
        ...
        taskTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "task_id", "task_name", "employee_id", "tl_id", "project_id"
            }
        ));
        ...
        task_name.setFont(new java.awt.Font("Century Schoolbook", 1, 20)); // NOI18N
        task_name.setForeground(new java.awt.Color(61, 142, 242));
        ...
        employee_id.setFont(new java.awt.Font("Century Schoolbook", 1, 20)); // NOI18N
        ...
        jLabel14.setText("Task_ID");

        task_id.setFont(new java.awt.Font("Century Schoolbook", 1, 20)); // NOI18N
        task_id.setForeground(new java.awt.Color(61, 142, 242));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(employee_id, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(task_id, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    void setInformation() {
        type.task.setTLID(user.users.getID());
        tl_id.setText("' TL_ID → " + type.task.getTLID() + " '");
    }
    
    boolean checkData() {
        if(!task_id.getText().isEmpty() && !task_name.getText().isEmpty() && !project_id.getText().isEmpty() && !employee_id.getText().isEmpty())
            return true;
    ...
    void setData() {
        type.task.setTaskID(Integer.valueOf(task_id.getText()));
        type.task.setTaskName(task_name.getText());
        type.task.setEmployeeID(Integer.valueOf(employee_id.getText()));
        type.task.setProjectID(Integer.valueOf(project_id.getText()));
    }
    
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        if(checkData() && taskTable.getSelectedRowCount() == 1) {
            setData();
            type.update(taskTable, 0);
            show.DataInTable("tasks", taskTable, 5);
    ...
    private void taskTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_taskTableMouseClicked
        currentRow = taskTable.getSelectedRow();

        if (taskTable.getSelectedRowCount() == 1) {
            task_id.setText(taskTable.getValueAt(currentRow, 0) + "");
            task_name.setText(taskTable.getValueAt(currentRow, 1) + "");
            employee_id.setText(taskTable.getValueAt(currentRow, 2) + "");
            project_id.setText(taskTable.getValueAt(currentRow, 3) + "");
        }
